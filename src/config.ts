...
const ConfigSchema = z.object({
    ...
    SNAPSHOT_FILTER_MODE: z.enum(['interactive', 'compact', 'full']).default('interactive'),
    SNAPSHOT_MAX_DEPTH: z.coerce.number().int().positive().default(5),
...
const rawConfig = {
    ...
    SNAPSHOT_FILTER_MODE: process.env.SNAPSHOT_FILTER_MODE,
    SNAPSHOT_MAX_DEPTH: process.env.SNAPSHOT_MAX_DEPTH,
